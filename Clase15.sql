...
select 	distinct c.nombre, c.apellido, a.codigo, a.nombre, f.letra, f.numero, f.fecha 
from 	clientes c 
join 	facturas f
on		c.codigo=f.codigoCliente
join	detalles d
on 		d.letra=f.letra and d.numero=f.numero
join	articulos a
...
-- listar artículos vendidos en el día de hoy
